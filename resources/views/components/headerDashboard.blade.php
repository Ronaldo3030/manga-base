            ...
            <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                ...
                <li class="mr-3 flex-1">
                    <a href="#"
                        ...
                        <i class="fas fa-plus-square md:pr-3"></i><span
                            class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">Mangas</span>
                    </a>
                </li>
                <li class="mr-3 flex-1">
                    <a href="{{route("admin.manga.index")}}"
                        ...
                        <i class="fa fa-envelope pr-0 md:pr-3"></i><span
                            class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">Adicionar
                            Manga</span>
                    </a>
                </li>
                <li class="mr-3 flex-1">
